...
function initImageCarousels() {
    ...
    carousels.forEach((carousel) => {
        const slides = Array.from(carousel.querySelectorAll('.img-carousel-slide'));
        const prevBtn = carousel.querySelector('.img-carousel-btn-prev');
        const nextBtn = carousel.querySelector('.img-carousel-btn-next');
